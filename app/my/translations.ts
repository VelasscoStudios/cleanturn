...
export const STRINGS = {
  en: {
    ...
    myJobsTab: "My Jobs",
    historyTab: "History",
    historySubhead: "Everything you've finished",
    cleansLabel: "Cleans",
    totalLabel: "Total",
    historyEmpty: "No cleans this month.",
  ...
  uk: {
    ...
    dateLocale: "uk-UA",
    // History tab
    myJobsTab: "Мої прибирання",
    historyTab: "Історія",
    historySubhead: "Усе, що ви завершили",
    cleansLabel: "Прибирань",
    totalLabel: "Разом",
    historyEmpty: "Цього місяця прибирань немає.",
    loadingHistory: "Завантаження…",
    prevMonth: "Попередній місяць",
    nextMonth: "Наступний місяць",
    monthLabel: "Місяць",
    yearLabel: "Рік",
    arrivedLabel: "Прибув(-ла) о",
    doneLabel: "завершено о",
  },
} as const;
